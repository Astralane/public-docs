...
* Frankfurt (Recommended): [<mark style="color:blue;">http://fr.gateway.astralane.io/iris?api-key=xxxx</mark>](https://fr.gateway.astralane.io/iris?api-key=xxxx)
  * IPv4 : 185.191.117.97
* Frankfurt: [<mark style="color:blue;">http://fr2.gateway.astralane.io/iris?api-key=xxxx</mark>](https://fr2.gateway.astralane.io/iris?api-key=xxxx)
  * IPv4 : 45.139.132.160
* San Francisco: [http://la.gateway.astralane.io/iris?api-key=xxxx](https://la.gateway.astralane.io/iris?api-key=xxxx)
  * IPv4 : 74.118.142.151
