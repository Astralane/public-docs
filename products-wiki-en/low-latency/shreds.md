...
| ----------- | ----------------- | ------------------------------------------------------------------------ |
| tier-1      | 0.1 sol           | Good for the dev testing, faster than Jito shreds.                       |
| tier-2      | 0.3 sol           | Ideal for the ultra-low-latency shred delivery and production workloads. |

As soon as you have enough tips accumulated in the 24-hour window, you will be upgraded immediately to the suitable tier.

{% hint style="info" icon="meteor" %}
While you are upgraded immediately, we will downgrade you gracefully. If you do not have enough tips in the last 24h window of tier-2, we will downgrade you to tier-1 for the next 24 hours, even if you didn't have enough tips for it.
{% endhint %}
...
{% hint style="info" %}
User Portal will be updated soon with detailed shred usage dashboard
{% endhint %}
...
[View source on GitHub](https://github.com/BCH-labs/shreds-monitor)
...
<summary>2. I tipped 10 SOL in one day but the Tier 2 threshold is 0.3 SOL/day – what happens?</summary>

If you tip more than the daily threshold, the extra amount rolls over. For example, tipping 10 SOL at a 0.3 SOL/day threshold covers you for \~33 days of Tier 2 access.
